...
read [here](https://ladybluenotes.hashnode.dev/from-a-casual-gamer-to-developer)), this is where I started - I had
several reasons why I started here, which I didn't understand initially, but that have become clearer as time has
passed.

For one, HTML is the foundation of the web - it is the standard markup language used for creating pages as well as web
applications. In addition, it is easy to learn and use. The syntax is simple and uses familiar elements (headers,
...
frameworks, such as CSS and JavaScript. It is also _crucial_ to know the more intimate details of HTML in order to
...
Just like my experience with HTML, I originally used CSS, or Cascading Style Sheets, to fiddle around with colours and
...
applications. Not only is it powerful in since it permits the creation of complex programs but it is widely supported
and popular. I can best describe JS as a way to add certain behaviours to web pages.
...
JavaScript is capable of full-stack development. On the front-end, a developer can be used it build the user interface
...
In addition to front and back-end development, JS also excels at tasks such as testing, automation and deployment. There
...
Being as powerful as it is, JavaScript introduced the possibility of developing full-stack applications, which includes
...
- [Create a task list](https://github.com/LadyBluenotes/TaskList)
- [Used a cocktail API that users could interact with](https://github.com/LadyBluenotes/TheHappyHourGuide)
- [Using NASA API to showcase daily photos](https://github.com/LadyBluenotes/NASA)
- [Make a pokedex](https://github.com/LadyBluenotes/the-poke-dex)

You can find more on [my GitHub](https://github.com/LadyBluenotes).
