---
title: Designing for Inclusivity: Tips and Best Practices
...
- Hidden content: Content that is hidden using CSS or JavaScript may not be perceivable to individuals using assistive technologies such as screen readers.
...
- Design controls and functions to be easy to use. They should be clear and easy to understand, with instructions provided if necessary.
...
If you're interested in learning some specifics, you can read my article about [making HTML more accessible](https://ladybluenotes.hashnode.dev/html-for-beginners-tags-and-accessibility).
