...
- Setting up username and email:
  ...
  `git config --global user.name "Sarah Gerrard"`

  `git config --global user.email hello@sarahgerrard.me`
...
This command allows you to have a copy of it on your local system and make changes to it.
...
- Play some games dedicated to learning Git:
