/* adapted from https://github.com/kobaltedev/solidbase/blob/main/src/default-theme/components/TableOfContents.tsx */
	...
	return (
		<li class="ml-0">
			<a
				...
				classList={{
					"text-#c9cecf hover:text-#edb4ab": props.data.href !== props.current,
					"text-#ae303c": props.data.href === props.current,
				}}
				class="no-underline"
			>
				{props.data.title}
